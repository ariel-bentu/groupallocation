  ...
  return (
    <div style={styles.root}>
      <AppBar position="static" color="default" >
        ...
        >
          <Tab label={"שיבוצים" + (value == 0 && tabDirty ? "*" : "")} {...a11yProps(0)} />
          <Tab label={"תלמידים" + (value == 1 && tabDirty ? "*" : "")} {...a11yProps(1)} />
          <Tab label={"חברים" + (value == 2 && tabDirty ? "*" : "")} {...a11yProps(2)} />
          <Tab label={"קבוצות" + (value == 3 && tabDirty ? "*" : "")} {...a11yProps(3)} />
        </Tabs>
      </AppBar>
      ...
      <TabPanel value={value} index={1}>
        <Pupils currentTask={currentTask} pupils={listPupils} msg={msg} setDirty={_setTabDirty} />
      </TabPanel>
